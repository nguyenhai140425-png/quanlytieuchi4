...
class EventProgressStatus(models.IntegerChoices):
    NOT_STARTED = 1, 'Chưa thực hiện'
    IN_PROGRESS = 2, 'Đang thực hiện'
    COMPLETED = 3, 'Hoàn thành'
    NOT_COMPLETED = 4, 'Chưa hoàn thành'
...
class Event(models.Model):
    ...
    completion_status = models.PositiveSmallIntegerField(
        choices=EventProgressStatus.choices, default=EventProgressStatus.NOT_STARTED
    )
    ...
    over_budget_note = models.TextField(null=True, blank=True)
